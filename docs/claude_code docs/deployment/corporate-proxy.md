...
| `raw.githubusercontent.com` | Changelog feed for [`/release-notes`](https://code.claude.com/docs/en/commands) and the release notes shown after updating; plugin marketplace install counts |
