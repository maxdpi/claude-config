...
URL Source: https://docs.anthropic.com/en/docs/claude-code/analytics
...
| --- | --- | --- | --- |
| Claude for Teams / Enterprise | [claude.ai/analytics/claude-code](https://claude.ai/analytics/claude-code) | Usage metrics, contribution metrics with GitHub integration, leaderboard, data export | [Details](https://docs.anthropic.com/en/docs/claude-code/analytics#access-analytics-for-team-and-enterprise) |
| API (Claude Console) | [platform.claude.com/claude-code](https://platform.claude.com/claude-code) | Usage metrics, spend tracking, team insights | [Details](https://docs.anthropic.com/en/docs/claude-code/analytics#access-analytics-for-api-customers) |
...
*   **Contribution metrics**: PRs and lines of code shipped with Claude Code assistance, with [GitHub integration](https://docs.anthropic.com/en/docs/claude-code/analytics#enable-contribution-metrics)
...
For per-user token counts and cost estimates, configure [OpenTelemetry export](https://code.claude.com/docs/en/monitoring-usage).
